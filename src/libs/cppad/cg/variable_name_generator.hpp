...
typedef struct FuncArgument {
    ...
    inline FuncArgument() : array(false) {}

    inline FuncArgument(const std::string& nam, bool a = true) : name(nam), array(a) {}
} FuncArgument;
...
public:
     ...
     */
    virtual const std::vector<FuncArgument>& getDependent() const { return _dependent; }
     ...
     */
    virtual const std::vector<FuncArgument>& getIndependent() const { return _independent; }
     ...
     */
    virtual const std::vector<FuncArgument>& getTemporary() const { return _temporary; }
