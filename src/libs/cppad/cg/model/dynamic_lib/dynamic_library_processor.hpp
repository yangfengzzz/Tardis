...
public:
    ...
    inline explicit DynamicModelLibraryProcessor(ModelLibraryCSourceGen<Base>& modelLibGen,
        ...
        : ModelLibraryProcessor<Base>(modelLibGen), _libraryName(std::move(libraryName)) {}
     ...
     */
    inline const std::string* getCustomLibraryExtension() const { return _customLibExtension.get(); }
     ...
     */
    inline void removeCustomLibraryExtension() { _customLibExtension.reset(); }
