...
void cppadcg_thpool_add_job(cppadcg_thpool_function_type function, void* arg, const float* avgElapsed, float* elapsed);
...
const size_t CPPADCG_PTHREAD_POOL_H_FILE_SIZE = 2422;
