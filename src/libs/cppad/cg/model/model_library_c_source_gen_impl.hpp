...
template <class Base>
const std::string ModelLibraryCSourceGen<Base>::FUNCTION_SETTHREADSCHEDULERSTRAT =
        "cppad_cg_thpool_set_scheduler_strategy";

template <class Base>
const std::string ModelLibraryCSourceGen<Base>::FUNCTION_GETTHREADSCHEDULERSTRAT =
...
template <class Base>
const std::string ModelLibraryCSourceGen<Base>::FUNCTION_SETTHREADPOOLGUIDEDMAXGROUPWORK =
        "cppad_cg_thpool_set_guided_maxgroupwork";

template <class Base>
const std::string ModelLibraryCSourceGen<Base>::FUNCTION_GETTHREADPOOLGUIDEDMAXGROUPWORK =
        "cppad_cg_thpool_get_guided_maxgroupwork";

template <class Base>
const std::string ModelLibraryCSourceGen<Base>::FUNCTION_SETTHREADPOOLNUMBEROFTIMEMEAS =
        "cppad_cg_thpool_set_number_of_time_meas";

template <class Base>
const std::string ModelLibraryCSourceGen<Base>::FUNCTION_GETTHREADPOOLNUMBEROFTIMEMEAS =
...
void ModelLibraryCSourceGen<Base>::generateModelsSource(std::map<std::string, std::string>& sources) {
    _cache.str("");
    LanguageC<Base>::printFunctionDeclaration(_cache, "void", FUNCTION_MODELS,
                                              {"char const *const** names", "int* count"});
    _cache << " {\n"
