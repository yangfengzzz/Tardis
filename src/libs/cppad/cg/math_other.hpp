...
template <class Base>
inline CppAD::cg::CG<Base> pow(const CppAD::cg::CG<Base>& x, const CppAD::cg::CG<Base>& y) {
...
template <class Base>
inline CppAD::cg::CG<Base> pow(const Base& x, const CppAD::cg::CG<Base>& y) {
    return CppAD::pow<Base>(CppAD::cg::CG<Base>(x), y);
}

template <class Base>
inline CppAD::cg::CG<Base> pow(const CppAD::cg::CG<Base>& x, const Base& y) {
