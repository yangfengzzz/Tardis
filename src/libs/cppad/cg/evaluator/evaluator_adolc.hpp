...
inline adouble sign(const adouble& val) {
    ...
    // adouble temp;
    // condassign(temp, val, adouble(1.0), adouble(-1.0)); // warning it should return zero if val == 0 but there is no
    // way to do this in Adol-C return temp;
}

inline adouble condExpLt(const adouble& left,
                         const adouble& right,
...
inline adouble condExpLe(const adouble& left,
                         const adouble& right,
                         const adouble& exp_if_true,
                         const adouble& exp_if_false) {
...
inline adouble condExpEq(const adouble& left,
                         const adouble& right,
                         const adouble& exp_if_true,
                         const adouble& exp_if_false) {
    throw CppAD::cg::CGException("Conditional operation (==) not implemented in ADOL-C");
...
inline adouble condExpGe(const adouble& left,
                         const adouble& right,
                         const adouble& exp_if_true,
                         const adouble& exp_if_false) {
    throw CppAD::cg::CGException("Conditional operation (>=) not implemented in ADOL-C");
...
inline adouble condExpGt(const adouble& left,
                         const adouble& right,
                         const adouble& exp_if_true,
                         const adouble& exp_if_false) {
    adouble temp;
...
inline adouble condExpNe(const adouble& left,
                         const adouble& right,
                         const adouble& exp_if_true,
                         const adouble& exp_if_false) {
    throw CppAD::cg::CGException("Conditional operation (!=) not implemented in ADOL-C");
...
class Evaluator<ScalarIn, double, adouble>
    : public EvaluatorOperations<ScalarIn, double, adouble, Evaluator<ScalarIn, double, adouble>> {
public:
